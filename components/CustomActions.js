...
// PropTypes defines what the props you send to a component should look like
...
export default class CustomActions extends React.Component {
    ...
    render() {
        return (
            <TouchableOpacity style={[styles.container]} onPress={this.onActionPress} accessible={true} accessibilityLabel="Extra chat options" accessibilityHint="This option allows you to take a new photo, send a photo from your album or share your location">
